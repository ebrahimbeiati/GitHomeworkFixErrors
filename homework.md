...
2.Clean local commits before pushing. 
3.Undo the local commits. 
4.Remove a file from GIT without removing from the file system. 
5.Reverting pushed commits. 
6.Avoid repeated merge conflicts.
7.Find a commit that broke something after a merge When people want to show off code to each other they can put it on Github
## Question 9
